...
//                   {/* CTA */}
//                   <Link to={`/courses?page=1&category=${category._id}`}>
...
//                 <div
//                   className={`
//                     relative bg-slate-800/50 backdrop-blur-sm border border-slate-700
//                     rounded-2xl overflow-hidden transition-all duration-300
//                     hover:scale-105 hover:border-slate-600 hover:shadow-2xl
...
//                       className="mt-auto w-full flex items-center justify-center gap-2 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors group-hover:scale-105"
//                     >
//                       Explore Now
//                       <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//                     </Link>
...
//           <Link
//             to="/login"
//             className="inline-flex bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white px-6 py-3 rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg shadow-blue-500/25 items-center gap-2"
//           >
//             <Compass className="w-5 h-5" />
//             Find My Perfect Path
//             <ArrowRight className="w-4 h-4" />
...
import { TrendingUp, ArrowRight, Star, Compass, Loader2 } from "lucide-react";
import { Link } from "react-router-dom";
import { useCategories } from "../hooks/useCategories.js";
import HighlightedText from "./ui/HighlightedText.jsx";
...
const CategrySection = () => {
  ...
  // ✅ FIX 1: Styled loading state with spinner
  if (isLoading) {
    return (
      <section className="py-16 px-6 bg-slate-900">
        <div className="max-w-7xl mx-auto">
            ...
            <div key={index} className="group cursor-pointer">
              <div
                className={`
                  ...
                  rounded-2xl overflow-hidden transition-all duration-300
                  hover:scale-105 hover:border-slate-600 hover:shadow-2xl
                  bg-gradient-to-br min-h-[400px] flex flex-col justify-between
                  ${category.gradient}
                `}
                // ✅ FIX 2: category.gradient (not categories.gradient)
                // ✅ FIX 3: min-h instead of fixed h — content overflow prevent
              >
                {/* Trending Badge */}
                {category.trending && (
                  <div className="absolute top-3 right-3 z-10 group-hover:animate-bounce">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {/* Stats Grid */}
                  {/* ✅ FIX 4: text-[10px] → text-xs (readable size) */}
                  ...
                  {/* CTA */}
                  <Link to={`/courses?page=1&category=${category._id}`}>
                    <button className="w-full flex items-center justify-center gap-2 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
                      Explore Now
                      <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </button>
                  </Link>
