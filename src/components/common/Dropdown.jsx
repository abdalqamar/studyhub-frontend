    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="hidden md:block text-left">
          ...
          <p className="font-['JetBrains_Mono'] text-slate-400 text-[10px] uppercase tracking-wide leading-tight">
            {user?.role}
          </p>
        </div>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-slate-800 border border-slate-700/50 rounded-lg shadow-xl overflow-hidden z-50">
          {/* User Info Header */}
