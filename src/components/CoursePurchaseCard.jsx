  ...
  return (
    <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl border border-slate-700/30 p-6 sticky top-6">
      ...
      <div className="border-t border-slate-700/50 pt-6 mt-6">
        <button className="w-full bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 hover:text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2">
          <Share />
          Share
        </button>
      </div>
