...
const LiveCodeDemo = () => {
  ...
  return (
    <div className="grid md:grid-cols-[1.4fr_1fr] border border-slate-700/50 rounded-2xl overflow-hidden bg-slate-900/60">
      {/* code pane */}
      <div className="border-b md:border-b-0 md:border-r border-slate-700/50">
        ...
        <pre className="m-0 p-4 sm:p-5 font-['JetBrains_Mono'] text-[12px] sm:text-[12.5px] leading-[1.75] text-white whitespace-pre overflow-x-auto min-h-[230px]">
      ...
      <div>
        <div className="px-4 py-2.5 border-b border-slate-700/50">
          <span className="font-['JetBrains_Mono'] text-[11px] text-slate-500 tracking-wide">
            TERMINAL
          </span>
        </div>
        <pre className="m-0 p-4 sm:p-5 font-['JetBrains_Mono'] text-[12px] sm:text-[12.5px] leading-[1.75] text-slate-400 whitespace-pre overflow-x-auto min-h-[230px]">
