...
const ShareModal = ({ isOpen, onClose, shareUrl, shareTitle }) => {
  ...
  const shareOnTwitter = () => {
    const text = shareTitle || "Check out this amazing course:";
    window.open(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-6 bg-gray-100 rounded-lg p-3">
          <input
            type="text"
            readOnly
            value={`${shareTitle} ${shareUrl}`}
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="p-4 hover:bg-gray-100 rounded-full transition-all hover:scale-110"
          ...
          <button
            ...
            className="p-4 hover:bg-blue-50 rounded-full transition-all hover:scale-110"
          ...
          <button
            ...
            className="p-4 hover:bg-green-50 rounded-full transition-all hover:scale-110"
