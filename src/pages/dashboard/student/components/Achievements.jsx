// src/pages/StudentDashboard/components/Achievements.jsx
import {
  Trophy,
  Award,
  Star,
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700 hover:border-slate-600 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {achievements.map((achievement) => {
          ...
          return (
            <div
              key={achievement.id}
              className={`relative ${achievement.bgColor} ${achievement.borderColor} border rounded-xl p-4 hover:bg-slate-800/80 transition-all duration-200 group cursor-pointer ${
            ...
            >
              ...
              <div
                className={`w-14 h-14 ${
                  achievement.earned ? achievement.color : "bg-slate-700"
              ...
              <div className="mb-3">
                <h4
                  className={`font-semibold text-sm mb-1 ${
                    achievement.earned ? "text-white" : "text-slate-300"
                  }`}
                >
                  {achievement.title}
                </h4>
      ...
      <div className="mt-6 text-center">
        <button className="px-6 py-2.5 bg-slate-700 hover:bg-slate-600 text-white rounded-lg font-medium text-sm transition-colors">
