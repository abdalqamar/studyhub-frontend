// src/pages/StudentDashboard/components/QuickActions.jsx
      ...
      {actions.map((action) => {
        ...
        return (
          <button
            ...
            className={`${action.bgColor} ${action.hoverColor} backdrop-blur-sm rounded-xl p-5 border border-slate-700 hover:border-slate-600 transition-all duration-200 text-left group relative overflow-hidden`}
          >
            {/* Badge */}
            {action.badge && (
