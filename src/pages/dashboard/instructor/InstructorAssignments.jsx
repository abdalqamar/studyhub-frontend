...
const InstructorAssignments = () => {
  ...
  const getGradeColor = (grade) => {
    ...
    if (firstChar === "B") return "text-blue-400";
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 rounded-xl p-5 border border-yellow-500/20">
          ...
          <div className="text-slate-400 text-sm">Late Submissions</div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-10 pr-4 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
      ...
      <div className="space-y-4">
        {filteredSubmissions.map((submission) => (
          ...
          >
            ...
            {/* Submission Details */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 bg-slate-900 rounded-lg p-4">
              <div>
                <div className="text-slate-500 text-xs mb-1">Submitted At</div>
            ...
            {/* Student Notes */}
            {submission.notes && (
              <div className="mb-4 bg-slate-900 rounded-lg p-4 border-l-4 border-blue-500">
            ...
            {/* Submitted Files */}
            <div className="mb-4">
              <div className="text-slate-400 text-xs mb-2">Submitted Files</div>
              <div className="flex flex-wrap gap-2">
                {submission.submittedFiles.map((file, index) => (
                  <button
                    key={index}
                    onClick={() => handleDownloadFile(file.url)}
                    className="flex items-center gap-2 bg-slate-900 hover:bg-slate-700 px-4 py-2 rounded-lg border border-slate-600 hover:border-slate-500 transition-colors"
                  >
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 border border-slate-600 hover:border-slate-500 hover:bg-slate-700 text-slate-300 px-4 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2"
              >
              ...
              {submission.status === "submitted" ? (
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-all shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={() => setShowGradeModal(submission)}
                  className="flex-1 bg-slate-700 hover:bg-slate-600 text-slate-300 px-4 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2"
                >
                  <Star className="w-4 h-4" />
                  Update Grade
                </button>
                ...
                <div className="space-y-2">
                  {selectedSubmission.submittedFiles.map((file, index) => (
                    <button
                      key={index}
                      onClick={() => handleDownloadFile(file.url)}
                      className="w-full flex items-center justify-between bg-slate-900 p-4 rounded-lg hover:bg-slate-700 transition-colors"
                    >
              ...
              {selectedSubmission.status === "graded" && (
                <div>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 space-y-3">
                    ...
                    <div className="text-slate-500 text-xs pt-2 border-t border-green-500/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
