  ...
  return (
    <div className="min-h-screen bg-surface-bg text-white relative overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 lg:px-8">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 via-blue-500/10 to-cyan-600-900/40"></div>
        <div className="max-w-7xl mx-auto">
          <div className="text-center relative z-10 mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-[#1e293b] rounded-full mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link
                ...
                className="bg-btn-primary hover:to-btn-primary-hover
                     px-7 py-4 rounded-xl font-semibold text-white text-base
              ...
              <button
                ...
                className="flex items-center gap-3 px-7 py-4 rounded-xl font-semibold text-base text-primary-text hover:text-blue-300  border border-blue-500/30 hover:bg-btn-secondary-hover transition-all h-14 shadow-md hover:shadow-cyan-500/10"
              >
                <div className="w-9 h-9 bg-blue-cyan-gradient rounded-full flex items-center justify-center">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-slate-800/50 backdrop-blur-xl border border-[#1E40AF] rounded-full">
              ...
              <span className="text-slate-300 text-sm">
                {liveStudents.toLocaleString()} students learning right now
              </span>
            </div>
          </div>
        </div>
