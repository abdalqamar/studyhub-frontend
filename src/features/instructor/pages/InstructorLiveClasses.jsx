...
const InstructorLiveClasses = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface to-surface-2 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="bg-surface-2/50 backdrop-blur-sm rounded-2xl p-6 border border-border/50 mb-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div className="flex-1">
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-gold to-purple-400 bg-clip-text text-transparent">
                Live Classes Management
              </h1>
              <p className="text-text-2 text-sm mt-2 flex items-center flex-wrap gap-2">
            ...
            <button
              ...
              className="w-full lg:w-auto bg-gradient-to-r from-gold to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center group"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          <div className="bg-surface-2/30 rounded-xl p-4 border border-border/30 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-text-2 text-sm">Upcoming Classes</p>
          ...
          <div className="bg-surface-2/30 rounded-xl p-4 border border-border/30 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-text-2 text-sm">Live Now</p>
                <p className="text-2xl font-bold text-white mt-1">
                  {
          ...
          <div className="bg-surface-2/30 rounded-xl p-4 border border-border/30 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-text-2 text-sm">Total Students</p>
                <p className="text-2xl font-bold text-white mt-1">
              ...
              <div
                ...
                className={`bg-gradient-to-r rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-xl border ${
                  status === "live"
                    ...
                    : "from-surface-2/50 to-surface-2/50 border-border-strong hover:border-border-strong"
                }`}
              >
                <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4 flex-1 w-full">
                    ...
                    <div className="flex-shrink-0">
                      <div className="bg-surface-2 rounded-xl p-3 text-center min-w-20">
                        <Calendar className="w-6 h-6 text-gold mx-auto mb-1" />
                        <div className="text-white font-bold text-lg">
                          {new Date(classItem.date).getDate()}
                        </div>
                        <div className="text-text-2 text-xs uppercase">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-text-2 text-sm">
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="p-2 hover:bg-surface-2 rounded-lg transition-colors w-10 h-10 flex items-center justify-center"
                      >
                        <MoreVertical className="w-5 h-5 text-text-2" />
                      </button>

                      {activeDropdown === classItem.id && (
                        <div className="absolute right-0 top-12 bg-surface-2 border border-border-strong rounded-xl shadow-2xl z-10 min-w-48">
                          <button
                            onClick={() => handleEditClass(classItem)}
                            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-text-2 hover:bg-surface-2 first:rounded-t-xl last:rounded-b-xl transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-red-400 hover:bg-surface-2 first:rounded-t-xl last:rounded-b-xl transition-colors"
                          >
        ...
        {liveClasses.length === 0 && (
          <div className="text-center py-12 bg-surface-2/30 rounded-2xl border border-border/30">
            <div className="w-20 h-20 bg-surface-2 rounded-full flex items-center justify-center mx-auto mb-4">
              <Video className="w-8 h-8 text-text-2" />
            </div>
            <h4 className="text-lg font-semibold text-white mb-2">
              No Live Classes Scheduled
            </h4>
            <p className="text-text-2 mb-6 max-w-sm mx-auto">
              Schedule your first live class to start engaging with your
              students in real-time
            </p>
            <button
              onClick={handleScheduleClass}
              className="bg-gradient-to-r from-gold to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105"
            >
        ...
        {(showScheduleModal || showEditModal) && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-surface-2 rounded-2xl p-4 sm:p-6 max-w-md w-full border border-border shadow-2xl max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="text-text-2 hover:text-white transition-colors p-2 hover:bg-surface-2 rounded-lg"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-surface-2 border border-border-strong rounded-xl text-white placeholder-text-3 focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-surface-2 border border-border-strong rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-3 bg-surface-2 border border-border-strong rounded-xl text-white placeholder-text-3 focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition resize-none"
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <button
                    ...
                    className="flex-1 px-6 py-3 border border-border-strong text-text-2 rounded-xl hover:bg-surface-2 transition-colors font-medium"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-gold to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all font-medium transform hover:scale-105"
                  >
        ...
        {showDeleteModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-surface-2 rounded-2xl p-6 max-w-sm w-full border border-border shadow-2xl">
